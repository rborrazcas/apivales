    ...
    @foreach ($vales as $index => $vale)
        ...
        <div class="body-title">
            <table class="body-title-table">
                <tr>
                    <td>Folio:</td>
                    <td class="body-title-folio">{{ $vale['id'] }}</td>
                    <td style="padding-left:170px;">Fecha:</td>
                    <td class="body-title-fecha">{{ $vale['FechaSolicitud'] }}</td>
                </tr>
            </table>
        </div>
        <div class="body">
            ...
            <table class="body-datos" style="margin-top: 15px;">
                ...
                <tr style="line-height:25px;">
                    ...
                    <td style="width:6%;font-weight:bold;text-align:center;border-bottom:1px solid;">{{ $vale['CP'] }}
                    </td>
                </tr>
                <tr style="line-height:25px;">
