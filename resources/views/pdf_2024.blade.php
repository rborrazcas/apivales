    ...
    @foreach ($vales as $index => $vale)
        ...
        <div class="container-fluid">
            <div class="subTitle" style="padding-top: 37px;">
                <h7>Programa Vale Grandeza - Compra Local 2024</h7>
            </div>
            <div class="folio">
            ...
            <div class="folio">
                ...
                <p style="font-size:8px;font-weight:bold;padding-top:5px;width: 90%; margin:auto auto;">Siendo las
                    ...
                    Lo anterior, con fundamento en el Artículo 17 fracciones IV y V; y Artículo 27 de las de las
                    Reglas de
                    Operación del Programa Vale Grandeza - Compra Local para el <br> Ejercicio Fiscal de 2024, con
                    presencia
                    del testigo de
