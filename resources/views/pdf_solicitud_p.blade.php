...
<head>
    ...
    <title>Acuse Proyectos Productivos</title>
    <style>
        body {
                ...
                <tr>
                    <td colspan="2" style="text-align:justify; line-height:25px;">
                        <span style="word-spacing:8px;">solicito ser
                            ...
                            style="text-decoration:underline; font-weight:bold;word-spacing:8px;"> Apoyo con
                            proyecto productivo </span> <span <span style="word-spacing:9px;">del Programa</span> <span
                            style="text-decoration:underline; font-weight:bold;word-spacing:12px;">
                            Proyectos Productivos </span>
                    </td>
                </tr>
                <tr>
