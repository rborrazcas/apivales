        ...
        <div class="folio">
            <table class="table table-bordered table-sm" style="font-size: 5px;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" class="informacion">{{ $id }}</td>
                        <td colspan="3"class="informacion">{{ $folio }}</td>
                        <td colspan="4"class="informacion">{{ $acuerdo }}</td>
                        <td colspan="1"class="informacion">{{ $region }}</td>
                        <td colspan="2" class="informacion">{{ $enlace }}</td>
                    </tr>
                    {{-- <tr>
                        <td colspan="2" class="encabezado">Responsable:</td>
        ...
        <div class="folio">
            <table class="table table-bordered table-sm" style="font-size: 5px;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" class="informacion">{{ $nombre }}</td>
                        <td colspan="3" class="informacion">{{ $curp }}</td>
                        <td colspan="6" class="informacion">{{ $domicilio }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3" class="informacion">{{ $municipio }}</td>
                        <td colspan="3" class="informacion">{{ $localidad }}</td>
                        <td colspan="3" class="informacion">{{ $colonia }}</td>
                        <td colspan="3" class="informacion">{{ $cp }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table class="table table-bordered table-sm" style="font-size: 9px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="informacion">{{ $folioinicial }}</td>
                        <td class="informacion">{{ $foliofinal }}</td>
