...
class CasosSeguimientoController extends Controller
{
    function getCasosSeguimiento(Request $request){

        $parameters = $request->all();

        try {
            
            $res = DB::table('casos_seguimiento')
            ->select(
                'id', 'FechaHora', 'idServicio', 'idEstadoActual', 'Comentario',
                'Cama', 'created_at', 'updated_at', 'UserCreated', 'UserUpdated'
            );
