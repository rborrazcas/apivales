...
{
    function getTriage(Request $request){
        ...
        try {
            ...
            ->select(
                ...
                'triage.idPaciente', 
                    ...
                    //Datos persona
                    'personas.id as idA', 
                    'personas.CURP as CURPA', 
                    'personas.Nombre as NombreA', 
                    'personas.Paterno as PaternoA',
                    'personas.Materno as MaternoA', 
                    'personas.Sexo as SexoA', 
                    'personas.FechaNacimiento as FechaNacimientoA', 
                    'personas.idEntidadNacimiento as idEntidadNacimientoA ',
                        'cat_estados.id as idB',
                        'cat_estados.Estado as EstadoB',
                        'cat_estados.Clave as ClaveB',

                    'personas.TelCasa as TelCasaA', 
                    'personas.TelCelular as TelCelularA', 
                    'personas.Calle as CalleA', 
                    'personas.NumExt as NumExtA', 
                    'personas.NumInt as NumIntA', 
                    'personas.Colonia as ColoniaA', 
                    'personas.CP as CPA', 
                    'personas.idMunicipio as idMunicipioA',
                        'cat_municipio.id as idC',
                        'cat_municipio.Municipio as MunicipioC',
                        'cat_municipio.Clave as ClaveC',
                    'personas.idLocalidad as idLocalidadA', 
                    ...
                    'personas.created_at as created_atA', 
                    'personas.updated_at as updated_atA',
                    'personas.UserCreated as UserCreatedA',
                    ...
                    'personas.UserUpdated as UserUpdatedA',
                ...
                'triage.idLocalidad', 
                'triage.Diagnostico', 
                'triage.FechaInicioPadecimiento', 
                'triage.Menos7Dias', 
                'triage.TieneTos', 
                'triage.TieneFiebre38', 
                'triage.TieneCefalea', 
                'triage.Tiene2oMas', 
                'triage.SintomaDisnea', 
                'triage.SintomaArtralgias', 
                'triage.SintomaMialgias', 
                'triage.SintomaOdinofagia', 
                'triage.SintomaRinorrea', 
                'triage.SintomaConjuntivitis', 
                'triage.SintomaDolorToracico', 
                'triage.SintomaVomito', 
                'triage.SintomaDiarrea', 
                'triage.CEdad65o5', 
                'triage.CDiabetesMellitus', 
                'triage.CHipertensionArterial', 
                'triage.CObesidad', 
                'triage.CEnfermedadCardiovascular', 
                'triage.CNeumopatiaCronica', 
                'triage.CNefropatiaCronica', 
                'triage.CHepatopatiaCronica', 
                'triage.CEnfermedadHematologica', 
                'triage.CEnfermedadNeurologicaCronica', 
                'triage.CVIH', 
                'triage.CCancer', 
                'triage.COtraInmunosupresion', 
                'triage.CEmbarazo', 
                'triage.C2SemanasPuerperio',
                'triage.TieneComorbilidad', 
                'triage.FC', 
                'triage.FR', 
                'triage.SaO2', 
                'triage.SaO2_FiO2', 
                ...
                'triage.Glasgow', 
                'triage.Temp', 
                'triage.MalestarGeneral', 
                'triage.ExisteAlgunaAlteracion', 
                'triage.PosibleCovid19', 
                'triage.UserCreated', 
                'triage.UserUpdated', 
                'triage.idServicio', 
                'triage.created_at', 
            ...
            //Relaciones solo de la tabla triage con persona a traves del campo idPaciente.
            ->leftJoin('personas','personas.id','=','triage.idPaciente')
            ...
            foreach($res as $data){
                $temp_persona = [
                   ...
                   'Sexo'=> $data->SexoA,
                   'FechaNacimiento' =>  $data->FechaNacimientoA,
                   'idEntidadNacimiento' =>  [
                        'id'=> $data->idB,
                        'Estado' => $data->EstadoB,
                        'Clave' => $data->ClaveB,
